...
import { CountdownwidgetWidgetProps, CountdownwidgetWidget } from "./countdownwidget-widget";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/countdownwidget-widget.svg";
...
const widgetAttributes: string[] = [
  'enddate', 'language',"bg",
 'message','messages','messagess','messagesss'
];
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <countdownwidget-widget message="world!"></countdownwidget-widget>
   */
  return class CountdownwidgetWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): CountdownwidgetWidgetProps {
      const attrs = this.parseAttributes<CountdownwidgetWidgetProps>();
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<CountdownwidgetWidget {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "countdownwidget-widget",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Countdownwidget Widget',
    iconUrl: "https://assets.streamlinehq.com/image/private/w_300,h_300,ar_1/f_auto/v1/icons/all-icons/timer-xizuqis1c1bft3afx5g9g.png/timer-417zrzd2bpc0rtyd5pzkjlg.png?_a=DATAiZkSZAA0"
};
